...
namespace hw2.Migrations
{
    ...
    [Migration("20200813041903_add_DateModified")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("hw2.Models.Course", b =>
                {
            ...
            modelBuilder.Entity("hw2.Models.CourseInstructor", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnName("CourseID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("hw2.Models.Department", b =>
                {
                    b.Property<int>("DepartmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("DepartmentID")
            ...
            modelBuilder.Entity("hw2.Models.Enrollment", b =>
                {
            ...
            modelBuilder.Entity("hw2.Models.OfficeAssignment", b =>
                {
                    b.Property<int>("InstructorId")
                        .HasColumnName("InstructorID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("hw2.Models.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("hw2.Models.Course", b =>
                {
                    b.HasOne("hw2.Models.Department", "Department")
                        .WithMany("Course")
            ...
            modelBuilder.Entity("hw2.Models.CourseInstructor", b =>
                {
                    b.HasOne("hw2.Models.Course", "Course")
                    ...
                    b.HasOne("hw2.Models.Person", "Instructor")
                        .WithMany("CourseInstructor")
            ...
            modelBuilder.Entity("hw2.Models.Enrollment", b =>
                {
                    ...
                    b.HasOne("hw2.Models.Person", "Student")
                        .WithMany("Enrollment")
            ...
            modelBuilder.Entity("hw2.Models.OfficeAssignment", b =>
                {
                    b.HasOne("hw2.Models.Person", "Instructor")
                        ...
                        .HasForeignKey("hw2.Models.OfficeAssignment", "InstructorId")
